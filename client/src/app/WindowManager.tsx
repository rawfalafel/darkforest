    ...
    return (
      ...
      >
        ...
        <div className="m-2">
              ...
              <tbody className="width-full" style={{ width: '100%' }}>
                <tr>
                  ...
                  <td colSpan={2} className="text-right">
                    {Math.round(this.state.planet.capacity / 100.0).toString()}
                  </td>
                </tr>
                <tr>
                  <td colSpan={2}>Growth:</td>
                  <td colSpan={2} className="text-right">
                    {Math.round(this.state.planet.growth / 100.0).toString()}
                  </td>
                </tr>
                <tr>
                  <td colSpan={2}>Hardiness:</td>
                  <td colSpan={2} className="text-right">
                    {Math.round(this.state.planet.hardiness / 100.0).toString()}
                  </td>
                </tr>
                <tr>
                  ...
                  <td colSpan={2} className="text-right">
                    {Math.round(
                      this.state.planet.stalwartness / 100.0
                    ).toString()}
                  </td>
                </tr>
                <tr>
          ...
          <div
            className={this.state.activeTab == 'miners' ? 'block' : 'hidden'}
          >
            Manage Miners:
          </div>
